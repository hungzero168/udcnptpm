            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                  <!-- Data -->
                  <p><strong>${orderdetail.bikecode}</strong></p>
                ...
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                  <!-- Quantity -->
                    ...
                    <div data-mdb-input-init class="form-outline">
                      <input id="form1" min="0" name="quantity" value="${orderdetail.amount }" type="number" class="form-control"  disabled/>
        ...
        <div class="col-md-5">
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <a href="dathang?ordercode=${ordercode }">
                Đặt hàng
              </a>
              </c:if>
            </div>
